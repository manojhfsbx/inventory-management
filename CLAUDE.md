...
- **saas-sidebar-redesign** skill: Use when redesigning the client's navigation shell, adding CSS design tokens, or restyling views to match the SaaS sidebar layout
